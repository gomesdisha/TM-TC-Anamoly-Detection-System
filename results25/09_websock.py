        ...
        async with websockets.connect(
            ...
            while True:
                ...
                try:
                    ...
                    # 🔹 CHANGED: Initialize telemetry with Timestamp FIRST
                    ...
                    try:
                        ...
                        print(len(telemetry) - 1)
                        print("\nFIRST 20 FEATURE NAMES:")
                        print(list(telemetry.keys())[1:21])  # Skip Timestamp in print
                        ...
                        if len(main.rows) % 1 == 0:
                            ...
                            print(f"✅ Saved {len(main.rows)} row(s) to live_tm.csv")
